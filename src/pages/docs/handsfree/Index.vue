...
q-page.full-height
  section.content
    .text-center
      ...
      p.text-subtitle1 📅 documentation coming soon!
  ...
  section.content
    .row.q-col-gutter-md.justify-center
      .col-12.col-md-9
        q-card
          q-card-section
            CodeEditor(:value='code.setup.npm' :options='options' :extraOptions='extraOptions')
</template>
...
export default {
  ...
  data: () => ({
    code: {
      setup: {
        npm: require('!!raw-loader!./code/setup.npm.html').default,
      }
    },
